...
let showDetails = async (slug) => {
    ...
    div.innerHTML = `
          ...
          <div><strong>Phone name : </strong><span>${data.data.name
        }</span></div>
          ...
          <div>
            <ul>
              ...
              <li><strong>Display Size:</strong> ${data.data.mainFeatures.displaySize
        }.</li>
              <li><strong>Chip Set:</strong> ${data.data.mainFeatures.chipSet
        }.</li>
              <li><strong>Memory:</strong> ${data.data.mainFeatures.memory
        }.</li>
